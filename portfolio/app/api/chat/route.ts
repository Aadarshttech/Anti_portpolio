...
function getLocalResponse(userMessage: string): string {
    ...
    if (msg.includes("thank") || msg.includes("thanks") || msg.includes("awesome") || msg.includes("great")) {
        return "You're welcome! 😊 Feel free to reach out anytime. If you'd like to start a project, contact Aadarsh via [WhatsApp](https://wa.me/9779860334317) or email at aadarshapandit@gmail.com.";
    }
