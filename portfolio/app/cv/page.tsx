                            ...
                            <div className="flex items-start gap-2">
                                ...
                                <div>
                                    <p className="font-semibold text-gray-900 leading-snug">
                                        <a href="http://lrec-conf.org/proceedings/lrec2026/workshops/chipsal/2026.chipsal-1.0.pdf" target="_blank" rel="noopener noreferrer" className="hover:text-[#1a4a8c] hover:underline transition-colors">
