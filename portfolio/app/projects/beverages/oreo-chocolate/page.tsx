            ...
            <div ref={containerRef} className="relative w-full" style={{ height: "600vh" }}>
                ...
                <div className="sticky top-0 left-0 w-full h-screen overflow-hidden">
                    ...
                    <div className="absolute top-1/2 left-5 -translate-y-1/2 z-30 hidden md:block">
                        <a href="/projects/beverages" className="w-12 h-12 pointer-events-auto rounded-full border border-white/20 flex items-center justify-center text-white/50 hover:text-white hover:border-white/60 transition-colors backdrop-blur-sm bg-white/5 cursor-pointer z-50 relative">
                            <ChevronLeft size={24} />
                        </a>
                    </div>
