...
function getFrameConfig() {
    if (typeof window === "undefined") return { count: TOTAL_FRAMES, step: 1, dir: "choco-frames" };
    ...
    return {
        count: TOTAL_FRAMES,
        step: 1,
        dir: isMobile ? "choco-frames-mobile" : "choco-frames",
    };
}

export const ChocoCanvas = ({
    scrollYProgress,
    className = "",
    onLoadComplete,
    onLoadProgress,
