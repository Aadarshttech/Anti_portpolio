...
const LoveNotes = () => {
    ...
    return (
        <section className="py-24 px-4 bg-gradient-to-b from-background via-blush/20 to-cream section-divider">
            <motion.div
                        ...
                        <AnimatePresence mode="wait">
                            {revealedIndex === i ? (
                                <motion.p
                                    ...
                                    className="font-handwritten text-lg text-foreground leading-snug"
                                >
                                    {note}
                                </motion.p>
                            ) : (
                                ...
                                >
                                    ...
                                    <span className="text-xs text-muted-foreground/70 font-medium">tap me</span>
                                </motion.div>
                            )}
                        </AnimatePresence>
                    </motion.div>
